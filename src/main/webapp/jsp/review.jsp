			...
			<div class="row-fluid">
				<div class="span8">
					...
					<dl id="details" class="dl-horizontal">
						...
						<dt>Abstract</dt>
						<dd>
							<a id="ab" class="action" href="#abstract" data-toggle="collapse"><i class="icon-chevron-right"></i> show abstract</a>
							...
							<script type="text/javascript">
								$('#abstract').on('show', function() {
	                                $('#ab').html('<i class="icon-chevron-down"></i> hide abstract');
                                });
                                $('#abstract').on('hide', function() {
	                                $('#ab').html('<i class="icon-chevron-right"></i> show abstract');
                                });
							</script>
						</dd>
						<dt>Degree Level</dt>
